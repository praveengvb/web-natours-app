...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ3ZicHJhdmVlbiIsImEiOiJjbDVhZHFqemUybGYzM2RxcWFsbWYxbnd3In0.zHlM2Xll_PjhIHs-QUR1Yg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    // style: 'mapbox://styles/mapbox/streets-v11', // style URL
    style: 'mapbox://styles/gvbpraveen/cl5ekzu12002715l7ah7vbb8k',
    scrollZoom: false //   center: [-87.661093, 42.000471],
    //   zoom: 3,
    //   interactive: false,
...
// type is eithter 'password' or 'data'
...
var stripe = Stripe('pk_test_51LK4eGAmRd9ExWukLyDReOsMjQnWOxoyiRCgNqa2dVACMLH4r34ZL7VEgBoTDfa4ZZZ1g8vpbOobcmiJcBYeEj4A002dsaVfNs');
...
if (logoutBtn) logoutBtn.addEventListener('click', _login.logout); // Update user
